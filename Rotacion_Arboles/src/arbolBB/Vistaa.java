...
//metodo que desbloquea los botones para el ordenamineto del arbol
    ...
    private void botonInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonInsertarActionPerformed
        ...
        try {
            //declaracion y conversion de los datos tipo string a int para la variable
            ...
            if (this.simulador.insertar(dato)) {
                ...
                //se activa el metodo inicializar para hacer el desbloqueo de los ordenes del arbol binario
                this.inicializar(true);
                //se llama al metodo que hara la parte grafica
                complementos();
